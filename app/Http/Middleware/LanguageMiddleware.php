...
class LanguageMiddleware
{
    ...
    public function handle(Request $request, Closure $next)
    {
        ...
        $lang = $request->route('locale', 'en');  // Default to 'en' if no language is provided
        ...
        $locale = $request->get('locale', config('app.locale')); // Default to app locale if not provided
